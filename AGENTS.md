...
- **Launch arguments** (fixtures only): `-UITestFixtures`, `-UITestFailFirstLoad`, `-UITestDarkMode`, `-UITestSeedPhoto`, `-UITestRemoteComment` (another client comments on the recycling chore about 1.5 s after the detail screen subscribes).
